...
import static com.siteware.ecommerce.entinties.enums.Promocoes.NENHUMA_PROMOCAO;
import static com.siteware.ecommerce.entinties.enums.Promocoes.TRES_POR_DEZ;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        User u1 = new User(null, "Alfredo");
        User u2 = new User(null, "Bitelo");

        Carrinho c1 = new Carrinho(null, new BigDecimal(10), u1);
        Carrinho c2 = new Carrinho(null, new BigDecimal(5), u2);

        Produto p1 = new Produto(null, "Arroz", new BigDecimal(10.5));
        Produto p2 = new Produto(null, "Feijao", new BigDecimal(5.5));
        Produto p3 = new Produto(null, "Carne", new BigDecimal(55.5));
